...
const categories = [
  {
    ...
    color: "bg-blue-500",
    image: "https://images.unsplash.com/photo-1550439062-609e1531270e?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTZ8fHByb2dyYW1taW5nfGVufDB8fDB8fHww",
    trending: true,
    recentPosts: [
  ...
  },
  {
    ...
    color: "bg-purple-500",
    image: "https://images.unsplash.com/photo-1607798748738-b15c40d33d57?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTB8fHByb2dyYW1taW5nfGVufDB8fDB8fHww",
    trending: true,
    recentPosts: [
  ...
  },
  {
    ...
    color: "bg-green-500",
    image:"https://images.unsplash.com/photo-1743862558324-64de6d680fbb?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8N3x8Y29tcHV0cnR8ZW58MHx8MHx8fDA%3D",
    trending: false,
    recentPosts: [
  ...
  },
  {
    ...
    color: "bg-pink-500",
    image: "https://images.unsplash.com/photo-1517487881594-2787fef5ebf7?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8bGlmZXN0eWxlfGVufDB8fDB8fHww",
    trending: false,
    recentPosts: [
            ...
            {filteredCategories.map((category) => (
              ...
              >
                <div className="relative overflow-hidden">
                  <Image
                    src={category.image || "https://images.unsplash.com/photo-1743398665751-2cd5d3cc9d46"}
                    alt={category.name}
                    width={300}
                    height={200}
            ...
            <CardContent>
              ...
              <div className="flex space-x-4">
                <Link href={`/category/${selectedCategory.slug}`} className="flex-1">
                  <Button className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700  ">
                    Explore Category
                  </Button>
                </Link>
