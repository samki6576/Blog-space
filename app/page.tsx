...
const featuredPosts = [
  {
    ...
    readTime: "5 min read",
    category: "Technology",
    image: "https://images.unsplash.com/photo-1484417894907-623942c8ee29?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8cHJvZ3JhbW1pbmd8ZW58MHx8MHx8fDA%3D",
    views: 1250,
    likes: 89,
    comments: 23,
    featured: true,
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1515879218367-8466d910aaa4?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8cHJvZ3JhbW1pbmd8ZW58MHx8MHx8fDA%3D",
    views: 890,
    likes: 67,
    comments: 15,
  },
  {
    ...
    readTime: "6 min read",
    category: "Design",
    image: "https://images.unsplash.com/photo-1542831371-29b0f74f9713?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8cHJvZ3JhbW1pbmd8ZW58MHx8MHx8fDA%3D",
    views: 1100,
    likes: 92,
    comments: 31,
  },
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-blue-600  to-pink-600 bg-clip-text text-transparent">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center max-w-md mx-auto">
            ...
            <Button className="bg-gradient-to-r from-blue-600   hover:from-blue-700  ">
              Search
            </Button>
          </div>
        </div>
            ...
            <Card className="overflow-hidden shadow-2xl border-0 bg-white/80 backdrop-blur-sm">
              <div className="md:flex">
                ...
                <div className="md:w-1/2 p-8">
                  <Badge className="mb-4 bg-gradient-to-r from-blue-600  ">
            ...
            {featuredPosts.slice(1).map((post) => (
              ...
              >
                <div className="relative overflow-hidden">
                  <Image
                    src={post.image || "https://images.unsplash.com/photo-1743398665751-2cd5d3cc9d46?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHw3fHx8ZW58MHx8fHx8"}
                    alt={post.title}
                    width={400}
                    height={250}
                    className="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-300"
                  />
                  <Badge className="absolute top-4 left-4 bg-gradient-to-r from-blue-600  ">
                    {post.category}
                  </Badge>
                </div>
                ...
                <CardContent>
                  ...
                  <Link href={`/blog/${post.id}`}>
                    <Button
                      variant="outline"
                      className="w-full group-hover:bg-gradient-to-r group-hover:from-blue-600 group-hover:  group-hover:text-white group-hover:border-transparent transition-all bg-transparent"
                    >
                      Read Article
                    </Button>
                  </Link>
      ...
      {/* Newsletter Section */}
      <section className="py-20 px-4 bg-gradient-to-r from-blue-600  ">
        <div className="container mx-auto text-center">
