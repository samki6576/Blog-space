...
import { Save, Eye, Upload, X, Plus, TestTube } from "lucide-react"
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      if (error) {
        ...
        alert(`Upload failed: ${error}`) // Show error to user
        return
      }
      ...
      if (url) {
        ...
        console.error("No URL returned from upload") // Debug log
        alert("Upload failed: No URL returned")
      }
    } catch (error) {
      console.error("Unexpected error during upload:", error) // Debug log
