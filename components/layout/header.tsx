                  ...
                  <DropdownMenuTrigger asChild>
                    <Button variant="ghost" className="relative h-8 w-8 rounded-full">
                      <Avatar className="h-8 w-8">
                        <AvatarImage
                          src={user.photoURL || profile?.photoURL || "/placeholder.svg"}
                          alt={user.displayName || profile?.displayName || user.email}
                        />
                        <AvatarFallback>
                          {(user.displayName || profile?.displayName || user.email)?.charAt(0).toUpperCase()}
                        </AvatarFallback>
                      </Avatar>
                    </Button>
                  </DropdownMenuTrigger>
